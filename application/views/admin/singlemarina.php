...
<a href="<?php echo base_url('marinas/editmarina/'); echo $data[0]['id']; ?>" class="btn btn-primary float-right" >Edit Marina</a> 
...
<table class="table table-hover"> 
  <tbody> 
    <tr>
      ...
      <td><?php echo $data[0]['appname']; ?></td>
    </tr>
    <tr>
      <th scope="row">Welcome To</th>
      <td><?php echo $data[0]['welcometo']; ?></td>
    </tr>
    <tr>
      <th scope="row">Weather location No.</th>
      <td><?php echo $data[0]['weatherlocation']; ?></td>
    </tr>
    <tr>
      <th scope="row">Appicon.</th> 
        <td>
          <?php if($data[0]['appicon']=='') {?>
            <img src="<?= base_url() ?>assets/images/swansea.png" alt="" style="max-width: 60px;">
          <?php } else{?>
             <img src="<?= base_url($data[0]['appicon'])?>" alt="" style="max-width: 60px;">
          <?php  } ?> 
        </td>
    </tr>
    <tr>
      ...
      <td>
        <?php if($data[0]['appicon']=='') {?>
          <img src="<?= base_url() ?>assets/images/swansea.png" alt="" style="max-width: 60px;">
        <?php } else{?>
           <img src="<?= base_url($data[0]['marinaicons'])?>" alt="" style="max-width: 60px;">
        <?php  } ?> 
      </td>
    </tr>
    <tr>
