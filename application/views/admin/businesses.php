...
<a href="<?php echo base_url('admin/adtypes/'.$this->session->userdata('marinauser').'/'.urlencode($this->session->userdata('marinaid'))); ?>"><i class="fas fa-arrow-left"></i> Back</a>
...
<div class="container">
  <div class="row">
	...
	<a class="btn btn-info white-text float-right" href="#!" data-toggle="modal" data-target="#addBusiness">Add Business</a>
      ...
      if (empty($data)) {
        ...
        foreach ($data as $row) {?>
          ...
          <li class="list-group-item">
            <a href="<?php echo base_url('admin/getbusiness/'.$row['id'].'/'.urlencode($row['name'])); ?>" class="search float-left text-black" ><?php echo $row['name']; ?></a> 
            <div class="float-right">
              <?php if ($row['_id'] != ''): ?> 
                <a href="#!" class="btn btn-success text-black ba-btn">Already Sent 
                  <i class="fas fa-clipboard-check"></i>
                </a>
              <?php endif ?>
              <a class="search btn btn-info" style="padding: 3px 30px;" href="<?php echo base_url('admin/getbusiness/'.$row['id']); ?>" title="View" data-placement="top" data-toggle="tooltip"><i class="far fa-eye text-white center"></i></a>
   ...
   <div class="modal-dialog" role="document">
     <div class="modal-content">
       ...
       <div class="modal-body">
         <form action="<?php echo base_url('admin/insertbusiness'); ?>" id="ajax-from" method="post" class="needs-validation"> 
            <input type="text" value="<?php echo $typeid; ?>" name="typeid" class="form-control" id="typeid" style="display: none;" > 
            <input type="text" value="<?php echo $apitypeid; ?>" name="apitypeid" class="form-control" id="apitypeid" style="display: none;" > 
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control  form-control-sm capitalize" name="1stname" id="1stname" >
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control  form-control-sm" name="long" id="long">
            </div>
