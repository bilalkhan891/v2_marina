...
function validation()
{
  ...
  $this->form_validation->set_rules('useremail', 'Email Address', 'required|trim|valid_email|is_unique[codeigniter_Mainmodel.email]');
  ...
  if($this->form_validation->run())
  {
   ...
   if($id > 0)
   {
    ...
    <p> Verify you email address <a href='".base_url()."Mainmodel/verify_email/".$verification_key."'>link</a>.</p>
...
function verify_email()
{
  if($this->uri->segment(3))
  {
   ...
   if($this->Mainmodel->verify_email($verification_key))
   {
